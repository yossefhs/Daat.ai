...
TXT = {
 "fr": {
  ...
  "meta_desc":lambda he,subj:f"Niveau 4 (Daat HaRav) du Siman {he} — page-passerelle : l’Admour HaZaken n’a pas rédigé ce siman dans son Choul’han Aroukh (les simanim 132-154 de Orah Haïm n’y figurent pas). Renvoi aux Niveaux 1-3 et au Siddour de l’Admour HaZaken. Sujet : {subj}.",
  ...
  "intro_p2":"Mais l’ouvrage est <strong>incomplet</strong> : l’Admour HaZaken n’a pas rédigé (ou l’on n’a pas conservé) toute la première partie d’Orah Haïm. La série des simanim <strong>132 à 154</strong> en fait partie. Il n’y a donc pas de texte du Rav à reproduire pour ce siman.",
  "miss_h":lambda he:f'<span class="he">סימן {he}</span> — un siman hors du Choul’han Aroukh HaRav',
  "miss_p1":"Le Choul’han Aroukh de l’Admour HaZaken couvre de larges pans d’Orah Haïm, mais pas de façon continue : plusieurs blocs manquent, dont <strong>les simanim 132-154</strong> (ils reprennent au siman 155). Ce siman appartient à cette lacune.",
  ...
  "src":lambda n:f'<li><strong>Mehaber & Rama, ce siman</strong> — <a href="/oh-quotidien/{n}/base">Niveau 1</a>, <a href="/oh-quotidien/{n}/lamdan">Niveau 2</a>, <a href="/oh-quotidien/{n}/synthese">Niveau 3</a>.</li>'
        ...
        '<li><strong>Choul’han Aroukh HaRav</strong> — les simanim voisins effectivement rédigés (jusqu’à קל״א, puis à partir de קנ״ה).</li>'
 ...
 "he": {
  ...
  "meta_desc":lambda he,subj:f"רמה 4 (דעת הרב) לסימן {he} — דף־גשר: אדמו״ר הזקן לא כתב סימן זה בשולחן ערוך שלו (סימנים קל״ב-קנ״ד באורח חיים אינם בשו״ע הרב). הפניה לרמות 1-3 ולסידור אדמו״ר הזקן. נושא: {subj}.",
  ...
  "intro_p2":"אך החיבור <strong>אינו שלם</strong>: אדמו״ר הזקן לא כתב (או שלא נשתמר) את כל חלקו הראשון של אורח חיים. סדרת הסימנים <strong>קל״ב עד קנ״ד</strong> נמנית עם החסר. משום כך אין טקסט של הרב לשחזר לסימן זה.",
  "miss_h":lambda he:f'<span class="he">סימן {he}</span> — סימן שאינו בשולחן ערוך הרב',
  "miss_p1":"שולחן ערוך אדמו״ר הזקן מקיף חלקים נרחבים של אורח חיים, אך לא ברצף: כמה מקטעים חסרים, ובהם <strong>סימנים קל״ב-קנ״ד</strong> (החיבור חוזר בסימן קנ״ה). סימן זה שייך לחסר זה.",
  ...
  "src":lambda n:f'<li><strong>המחבר והרמ״א, סימן זה</strong> — <a href="/oh-quotidien/{n}/base/he">רמה 1</a>, <a href="/oh-quotidien/{n}/lamdan/he">רמה 2</a>, <a href="/oh-quotidien/{n}/synthese/he">רמה 3</a>.</li>'
        ...
        '<li><strong>שולחן ערוך הרב</strong> — הסימנים הסמוכים שנכתבו (עד קל״א, ומסימן קנ״ה ואילך).</li>'
 ...
 "en": {
  ...
  "meta_desc":lambda he,subj:f"Level 4 (Daat HaRav) of Siman {he} — bridge page: the Alter Rebbe did not write this siman in his Shulchan Aruch (simanim 132-154 of Orach Chayim are absent from Shulchan Aruch HaRav). Pointer to Levels 1-3 and to the Alter Rebbe’s Siddur. Topic: {subj}.",
  ...
  "bridge_p":lambda he:"<strong>This siman has no Level 4: the Alter Rebbe did not write it in his Shulchan Aruch.</strong> Simanim <strong>132 to 154</strong> of Orach Chayim are absent from Shulchan Aruch HaRav (this portion was not written by the Rav). In keeping with the site’s rule, <strong>no Shulchan Aruch HaRav text is reconstructed or invented here</strong>. Study this siman at Levels 1-3 (the text of the Mechaber and the Rama); the Alter Rebbe’s practice on prayer is recorded in his <strong>Siddur</strong> (Seder ha-Tefillah and its Piskei Dinim).",
  ...
  "intro_p2":"But the work is <strong>incomplete</strong>: the Alter Rebbe did not write (or it was not preserved) all of the first part of Orach Chayim. The run of simanim <strong>132 to 154</strong> is part of this gap. There is therefore no text of the Rav to reproduce for this siman.",
  "miss_h":lambda he:f'<span class="he">סימן {he}</span> — a siman outside Shulchan Aruch HaRav',
  "miss_p1":"The Alter Rebbe’s Shulchan Aruch covers large parts of Orach Chayim, but not continuously: several blocks are missing, among them <strong>simanim 132-154</strong> (the work resumes at siman 155). This siman belongs to that gap.",
  ...
  "src":lambda n:f'<li><strong>Mechaber & Rama, this siman</strong> — <a href="/oh-quotidien/{n}/base/en">Level 1</a>, <a href="/oh-quotidien/{n}/lamdan/en">Level 2</a>, <a href="/oh-quotidien/{n}/synthese/en">Level 3</a>.</li>'
        ...
        '<li><strong>Shulchan Aruch HaRav</strong> — the neighbouring simanim actually written (up to קל״א, and from קנ״ה onward).</li>'
...
SIMANIM=[
 (132,"קל״ב","דיני קדושת ובא לציון — la Kedousha de « Ouva LeTzion »"),
 (133,"קל״ג","דין ברכו — dire « Barekhou » après la prière"),
 (134,"קל״ד","סדר והוא רחום והגבהת התורה — « Vehou Ra'houm » et l'élévation de la Torah"),
]
