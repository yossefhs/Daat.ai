...
L = {
    ...
    "he": {
        ...
        "title": "הרב יוסף חיים סמאמא — מחבר דעת תורה",
        "desc": "תולדות הרב יוסף חיים סמאמא: לימוד בישיבות חב״ד, סמיכה מתומכי תמימים, והחזון שמאחורי דעת תורה.",
        "nav": {"shabbat": "הלכות שבת", "chat": "💬 דעת AI", "comm": "קהילה",
                "about": "אודות", "soutenir": "♥ תמיכה", "home": "דף הבית"},
        "crumb": "המחבר",
        "hero_meta": "דעת תורה · המחבר",
        "h1": "הרב יוסף חיים סמאמא",
        "subtitle": "מייסד דעת תורה — למען לימוד תורה בהיר, חי ונאמן למקורות.",
        "body": [
            "הרב יוסף חיים סמאמא גדל בישיבות ובכוללי חב״ד, שם למד במשך שנים רבות ובהתמדה תורה, הלכה וחסידות.",
