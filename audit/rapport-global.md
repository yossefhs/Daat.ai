...
> **Statut : audit EN COURS — phase automatique terminée ; revue approfondie = 90 simanim Shabbat sur 124 (lots 1-12, simanim 242-331 contigus), 861 constats.**
...
>
> **Lots 1-12 terminés — simanim 242-331 (contigus, 90 simanim) → 861 constats de contenu** dans `erreurs-halakha.csv`. Revue en cours vers 332+.
