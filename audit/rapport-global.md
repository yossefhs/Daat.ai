...
> **Statut : audit EN COURS — Hilkhot Shabbat TERMINÉ (124/124, IDs H-XXX) ; Orah Haïm quotidien TERMINÉ (64/64, IDs Q-XXX) ; Yoreh Deah 7/50 revus (bassar behalav 87-93, lot 27, IDs YD-XXX). Total : 1826 constats.**
...
>
> **HILKHOT SHABBAT COMPLET (124 simanim → 1192 constats, IDs H-XXX) + Orah Haïm quotidien COMPLET (simanim 1-64 → 600 constats, IDs Q-XXX) + Yoreh Deah lot 27 (simanim 87-93 → 34 constats, IDs YD-XXX) = 1826 constats** dans `erreurs-halakha.csv`. Revue Yoreh Deah en cours (bassar behalav terminé, suite : 94-118 puis nidda 183-200).
