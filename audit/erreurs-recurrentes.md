...
> Basé sur la revue sémantique des **124 simanim de Hilkhot Shabbat (242-365, COMPLET — IDs H-XXX)** de **64/64 simanim d'Orah Haïm quotidien (COMPLET — IDs Q-XXX)** et de **50/50 simanim de Yoreh Deah COMPLET (issour veheter 87-118 + nidda 183-200 — IDs YD-XXX)**, plus **16/23 articles du Blog (IDs BL-XXX)** — 2213 constats dans `erreurs-halakha.csv`.
