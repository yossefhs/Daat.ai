# DAAT — Erreurs récurrentes (revue approfondie, lots 1-12 : 90 simanim)

> Basé sur la revue sémantique des simanim **242-331 (contigus)** (861 constats dans `erreurs-halakha.csv`).
