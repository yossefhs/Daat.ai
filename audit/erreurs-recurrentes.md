# DAAT — Erreurs récurrentes (revue approfondie, lots 1-14 : 104 simanim)

> Basé sur la revue sémantique des simanim **242-345 (contigus)** (969 constats dans `erreurs-halakha.csv`).
